    ...
    return(
        ...
        <div className="container mx-auto px-4">
                ...
                <div className="mb-8 md:mb-0 ml-10">
                    ...
                    <div className="flex space-x-4 mt-6">
                        <motion.button
                             ...
                             whileTap={{ scale: 0.95 }}
                        >
                            <a href="https://www.youtube.com/channel/UCepXV4ZIdW4mK9CL95-wTAQ" className="text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                        >
                            <a href="https://www.instagram.com/asce.nd87/" className="text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                        >
                            <a href= "https://www.facebook.com/profile.php?id=61575891677038" className="text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center ml-10">
                <p className="text-gray-400 text-sm">© 2025 Ascend. Tất cả quyền được bảo lưu.</p>
