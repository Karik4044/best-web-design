                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-400 hover:text-white">Sức khỏe</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white">Kỹ năng</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white">Tinh thần</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white">Học tập</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-white">Đội ngũ</a></li>
