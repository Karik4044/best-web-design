                    ...
                    <div className="md:w-1/2 flex justify-center">
                        <div className="relative w-80 h-80">
                            ...
                            <svg className="absolute inset-0" viewBox="0 0 320 640" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="10" y="10" width="300" height="620" rx="30" fill="white" stroke="#E2E8F0" strokeWidth="4"/>
                                <rect x="20" y="30" width="280" height="580" rx="20" fill="#F7FAFC"/>
                                <circle cx="160" cy="610" r="15" fill="#E2E8F0"/>
                                ...
                                <rect x="40" y="330" width="240" height="80" rx="10" fill="white" stroke="#E2E8F0" strokeWidth="2"/>
                                <text x="60" y="360" fill="#2D3748" fontFamily="Montserrat" fontSize="14" fontWeight="600">Học từ vựng mới</text>
                                <text x="60" y="385" fill="#718096" fontFamily="Montserrat" fontSize="12">Ngày 5/30 • 16% hoàn thành</text>
                                <rect x="60" y="395" width="200" height="6" rx="3" fill="#EDF2F7"/>
                                <rect x="60" y="395" width="32" height="6" rx="3" fill="#3EB489"/>
                                
                                <circle cx="160" cy="480" r="30" fill="#FF7F50"/>
                                <text x="152" y="486" fill="white" fontFamily="Montserrat" fontSize="24" fontWeight="bold">+</text>
                            </svg>
                        </div>
                    </div>
                </div>
