                        ...
                        >
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Trái Đất</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex space-x-4">
                                    <a href="#" className="bg-orange-100 p-3 rounded-full hover:bg-orange-500 hover:text-white transition-colors duration-300">
