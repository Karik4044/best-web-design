        ...
        <div className="py-24 bg-gray-50 dark:bg-gray-900">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                    ...
                    >
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Tầm Nhìn</h2>
                        <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <motion.div
                        ...
                        className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg md:col-span-2"
                        whileHover={{ 
                            scale: 1.02,
                            boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
                            transition: { duration: 0.2 }
                    ...
                    >
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Giá Trị Cốt Lõi</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            >
                                ...
                                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Đổi Mới</h3>
                                <p className="text-gray-600 dark:text-gray-300">Luôn tìm kiếm những cách tiếp cận mới và hiệu quả</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Cộng Đồng</h3>
                                <p className="text-gray-600 dark:text-gray-300">Xây dựng và phát triển cộng đồng tích cực</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Đáng Tin Cậy</h3>
                                <p className="text-gray-600 dark:text-gray-300">Cam kết chất lượng và độ tin cậy trong mọi hoạt động</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
